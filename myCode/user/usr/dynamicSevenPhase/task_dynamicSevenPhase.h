#ifndef TASK_DYNAMICSEVENPHASE_H
#define TASK_DYNAMICSEVENPHASE_H

#include "sys/scheduler.h"
#include "drv/analog.h"

// Frequency that this task is called (in Hz)
#define TASK_DYNAMICSEVENPHASE_UPDATES_PER_SEC (25000)
#define TASK_DYNAMICSEVENPHASE_INTERVAL_USEC   (USEC_IN_SEC / TASK_DYNAMICSEVENPHASE_UPDATES_PER_SEC)
...
#endif // TASK_DYNAMICSEVENPHASE_H
